/*
  Sybase version if the pubs database build
*/
...
--exec sp_dropmessage @message_num=699125
EXEC sp_addmessage @message_num=699125, @message_text="%1! %2!"

DECLARE @dttm VARCHAR(55)
SELECT  @dttm=convert(VARCHAR,getdate(),113)

RAISERROR 699125 "Beginning InstPubs.SQL at %1! ", @dttm

GO

IF EXISTS (SELECT * FROM master..sysdatabases WHERE name='pubs')
BEGIN
  RAISERROR 699125 'Dropping existing pubs database ....'
  DROP DATABASE pubs
END
GO
...
RAISERROR 699125 'Creating pubs database....'
GO
/*
   Use default size with autogrow
*/

CREATE DATABASE pubs ON DEFAULT=100 log ON syblog01=10
GO
...
IF db_name() <> 'pubs'
   RAISERROR 699125 'Error in InstPubs.SQL, ''USE pubs'' failed!  Killing the SPID now.'
GO
...
RAISERROR 699125 'Now at the create table section ....'
...
(
   ...
   job_desc varchar(50) DEFAULT 'New Position - title not formalized yet'
NOT NULL,
...
RAISERROR 699125 'Now at the create trigger section ...'
...
BEGIN
   RAISERROR 699125 'Job id 1 expects the default level of 10.'
   ROLLBACK TRANSACTION
END
ELSE
IF NOT (@emp_lvl BETWEEN @min_lvl AND @max_lvl)
BEGIN
   RAISERROR 699125 'The level for job_id:%d should be between %d and %d.',
...
RAISERROR 699125 'Now at the inserts to authors ....'
...
RAISERROR 699125 'Now at the inserts to publishers ....'
...
RAISERROR 699125 'Now at the inserts to pub_info ....'
...
RAISERROR 699125 'Now at the inserts to titles ....'
...
RAISERROR 699125 'Now at the inserts to titleauthor ....'
...
RAISERROR 699125 'Now at the inserts to stores ....'
...
RAISERROR 699125 'Now at the inserts to sales ....'
...
RAISERROR 699125 'Now at the inserts to roysched ....'
...
RAISERROR 699125 'Now at the inserts to discounts ....'
...
RAISERROR 699125 'Now at the inserts to jobs ....'
...
RAISERROR 699125 'Now at the inserts to employee ....'
...
RAISERROR 699125 'Now at the create index section ....'
...
RAISERROR 699125 'Now at the create view section ....'
...
RAISERROR 699125 'Now at the create procedure section ....'
...
--  These don't work on sybase 12.5
--
...
RAISERROR 699125 'Now at the update statistics section ....'
...
DECLARE @dttm varchar(55)
SELECT  @dttm=convert(varchar,getdate(),113)
RAISERROR 699125 'Ending InstPubs.SQL at %1! ....',@dttm
